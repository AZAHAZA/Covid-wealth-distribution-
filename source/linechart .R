...
wealth_category <- read_csv("~/Documents/UW /Info 201/Workspace/dfa-income.csv",show_col_types = FALSE)
...
fig <- plot_ly(
  ...
  mode = "lines" 
    ...
    title = "Wealth Distribution During Pandemic and pre- pandemic",
