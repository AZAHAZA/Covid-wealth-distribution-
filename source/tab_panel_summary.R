...
tab_panel_summary <-tabPanel(
    ...
    p("Our report chose to focus on the distribution of wealth within various groups the United States and the effects 
      ...
      Following the pandemic that disparity jumped to 6 times.  The next key take away came from our box plot.  
      The box plot showed the distribution of wealth in America by level of education.  You can see that the majority of 
